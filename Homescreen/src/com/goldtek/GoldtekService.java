 ...
 * 
 * Copyright (C) 2013-2014 Goldtek Technologies Co LTD. 
 * 
 ...
 * </ol>
 */
public class GoldtekService extends AccessibilityService {

    /** Tag for logging from this service. */
    private static final String LOG_TAG = "GoldtekService";
    
    
    public static final String notificationPreferences = "notification_preferences";
...
//    }
    ...
    public void onServiceConnected() {
        ...
        info.eventTypes = AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED;//64;
    ...
    public String shortendSenserNameFromPackage(String sender_package){
    	
    	if(sender_package == null){
    		return "unknown";
    	}
    	...
    	if ((sender_package.equalsIgnoreCase("jp.naver.line.android"))){
   		 str = "Line";
   		 return str;
   	    }
    	
    	if ((sender_package.equalsIgnoreCase("com.whatsapp"))){
    		 str = "WhatsApp";
    		 return str;
    	}
        if ((sender_package.equalsIgnoreCase("com.google.android.gm"))){
    		str = "Gmail";
    		return str;
    	}
        
        
        if ((sender_package.equalsIgnoreCase("com.twitter.android"))){
    		str = "twitter";
    		return str;
    	}
        
        if ((sender_package.equalsIgnoreCase("com.google.android.email"))){
    		
        	str = "Android Email";
        	return str;
    	}
        if ((sender_package.equalsIgnoreCase("com.sec.android.email"))){
        	str = "Samsung-android Email";
        	return str;
        }
        if ((sender_package.equalsIgnoreCase("com.htc.android.mail"))){
        	str = "HCT Email";
        	return str;
        }
        if ((sender_package.equalsIgnoreCase("com.android.email"))){
        	str = "android Email";
        	return str;
        }
        if ((sender_package.equalsIgnoreCase("com.motorola.blur.email"))){
        	str = "MOTO-BLUR Email";
        	return str;
        }
        /***********************************************************************************/
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
       ...
       // .show();
    	...
    	Parcelable localParcelable = event.getParcelableData();
