/**
 * Copyright 2013-present Goldtek technology Co LTD .
 * 
 * 
...
public class MainActivity extends Activity {
	...
	private static final String TAG = "GTIW10-MainActivity";
	...
	/*This is to enble the Accessibility service to receive notification*/
	private Button mBtnAccessibilityService;
	private Button mBtnWatchSetting;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBtnWatchSetting = (Button) findViewById(R.id.btnWatchSetting);
		...
		mBtnDisconnect.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
	        	...
	        	String packageName = "com.goldtek";
	            String className = "NotificationSenderService";
	            
				Intent localIntent3 = new Intent();			
				localIntent3.setAction("DISCONNECT_TO_BT");
				localIntent3.putExtra("userDisconnect", true);
				localIntent3.putExtra("mybtdevice", mDevice);
		...
		mBtnAccessibilityService.setOnClickListener(new OnClickListener() {
		...
		mBtnWatchSetting.setOnClickListener(new OnClickListener() {
        ...
        localIntent2.putExtra("mybtdevice", mDevice);
	...
	static void forwardSMStowatch( String str){
