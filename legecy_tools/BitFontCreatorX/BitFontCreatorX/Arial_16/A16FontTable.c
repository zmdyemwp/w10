...
unsigned char GDI_GetArial16StringWidth(char * str) {
	int index = 0;
	int result = 0;
	int i = 0;
...
void GDI_PrintArial16String(int x, int y, unsigned char * str, int alignment, bool highlight) {
